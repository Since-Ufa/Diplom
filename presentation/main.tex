...
\begin{frame}{Комплексы с метилтиогруппой. Сравнение с экспериментом.}
	\begin{columns}
		...
		\begin{figure}[!h]
			...
			\caption{\footnotesize Модельные спектры поглощения комплексов с метилтиогруппой, полученные при помощи метода CAM-B3LYP/def2-TZVP в газовой фазе.}
		\end{figure}
		...
		\begin{figure}[H]
			...
			\caption{\footnotesize Модельные спектры поглощения комплексов с метилтиогруппой, полученные при помощи метода M06-2X/def2-TZVP в газовой фазе.}
		\end{figure}
...
\begin{frame}{\large Комплексы с метилтиогруппой. Спектр поглощения кластера \ce{[Cu2[SCH3]2]^{-2}}.}
	...
	\begin{columns}
		...
		\begin{figure}[!htb]
			...
			\subfloat[Переход 2px$\rarr$2py (396,1\ths нм)]{ \includegraphics[clip,width=0.5\columnwidth]{pictures/orbitals/Cu2L2_1.jpg} }
			\subfloat[Переход 2px$\rarr$3pz (373,4\ths нм)]{ \includegraphics[clip,width=0.5\columnwidth]{pictures/orbitals/Cu2L2_2.jpg} }
			
			\subfloat[Переход 2px$\rarr$3px (365,3\ths нм)]{ \includegraphics[clip,width=0.5\columnwidth]{pictures/orbitals/Cu2L2_3.jpg} }
...
\begin{frame}{Комплексы с цистеином. Сравнение с экспериментом.}
	\begin{columns}
		...
		\begin{figure}[!h]
			...
			\caption{\footnotesize Модельные спектры поглощения комплексов с цистеином, полученные при помощи метода CAM-B3LYP/def2-TZVP в газовой фазе.}
		\end{figure}
		...
		\begin{figure}[H]
			...
			\caption{\footnotesize Модельные спектры поглощения комплексов с цистеином, полученные при помощи метода M06-2X/def2-TZVP в газовой фазе.}
		\end{figure}
