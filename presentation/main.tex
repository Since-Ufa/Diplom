...
\begin{frame}{Введение. Постановка задачи.}
	...
	\column{0.5\textwidth}
		...
		\begin{figure}
		    ...
		    \caption{\centering \footnotesize Спектры возбуждения (1) и люминесценции\ths (2) для Cys-CuNC. [1]}
		\end{figure}
		\vfill
...
\begin{frame}{Задачи работы}
	\justify
	Целью настоящей работы является определение структуры образцов, содержавшихся в растворе. \\[0.5cm]
