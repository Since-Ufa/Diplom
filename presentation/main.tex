...
\institute{Санкт-Петербургский Государственный Университет, Фзический факультет \\ Кафедра молекулярной биофизики и физики полимеров}

\titlegraphic{\includegraphics[width=9cm]{Logo_new.jpg}}
...
\begin{frame}{Введение. Металлические нанокластеры.}
	\begin{columns}
		...
		\begin{alertblock}{Металлические нанокластеры}
			 \footnotesize — объекты, состоящие из единиц–сотен атомов металлов. Благодаря малым размерам, они демонстрируют дискретные молекулярно-подобные энергетические уровни. Это делает возможным их детектирование при помощи фотометрических методов измерения поглощения, комбинационного рассеяния и люмиинесценции.
		\end{alertblock}
		\vfill
		...
		\begin{figure}
			...
			\caption{\centering \scriptsize Трёхатомный комплекс меди с метилтиогруппой.}
		\end{figure}
...
\begin{frame}{Введение. Постановка задачи.}
	...
	\column{0.5\textwidth}
	    ...
	    \begin{alertblock}{Постановка задачи}
	        \scriptsize В статье Xiaofang\ths Jia,et.al.\ths[1] получены экспериментальные спектры поглощения комплексов меди, кэпированных цистеином (Cys-CuNC). Исходя из приведённой масс-спектрометрии, наиболее часто встречается комплекс \ce{CuL2}. Предположительно, основной вклад в спектры поглощения вносит комплекс \ce{Cu2L2}.
	    \end{alertblock}
	...
	\column{0.5\textwidth}
		...
		\begin{figure}
		    ...
		    \caption{\centering \footnotesize Поглощение (1) и испускание (2) для Cys-CuNC. [1]}
		\end{figure}
		\vfill
...
\begin{frame}{Комплексы с метилтиогруппой. Сравнительный анализ спектров.}
	...
	\begin{figure}[H]
		...
		\caption{\footnotesize  Рассчитанные спектры поглощения для комплекса \ce{[Cu2(SCH3)2]^{-2}} в газовой фазе.\\ Лоренцево уширение с полушириной 15\ths нм.}
	\end{figure}
...
\begin{frame}{Комплексы с метилтиогруппой. Сравнительный анализ спектров.}
	\begin{columns}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{pictures/spectra/Cu3_vacuum.eps}
			\caption{\footnotesize Рассчитанные спектры поглощения для комплекса \ce{[Cu3(SCH3)2]^{-1}} в газовой фазе.\\ Лоренцево уширение с полушириной 15\ths нм.}
		\end{figure}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{pictures/spectra/Cu4_vacuum.eps} 
			\caption{\footnotesize Рассчитанные спектры поглощения для комплекса \ce{[Cu4(SCH3)3]^{-1}} в газовой фазе.\\ Лоренцево уширение с полушириной 15\ths нм.}
		\end{figure}
...
\begin{frame}{Комплексы с метилтиогруппой. Сравнительный анализ спектров.}
	\begin{columns}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=1.1\textwidth]{pictures/spectra/Cu5_vacuum.eps}
			\caption{\footnotesize Рассчитанные спектры поглощения для комплекса \ce{[Cu5(SCH3)4]^{-1}} в газовой фазе.\\ Лоренцево уширение с полушириной 15\ths нм.}
		\end{figure}
		...
		\begin{table}[H]
			...
			\begin{tabular}{|c|c|c|c|c|}
				...
				0,39		&   0,25		& 0,33		& 0,35	& 0,43	 	\\ \hline
			\end{tabular}
		\end{table}
		...
		\begin{table}[H]
			...
			\begin{tabular}{|c|c|c|c|c|}
				\hline
				BHandH-LYP	&	CAM-B3LYP	& M06-2X	& PBE0	& wB97X 	\\ \hline
				0,20		&   0,17		& 0,21		& 0,31	& 0,35 		\\ \hline
			\end{tabular}
		\end{table}	
...
\begin{frame}{Комплексы с метилтиогруппой. Сравнение с экспериментом.}
	\begin{columns}
		...
		\begin{figure}[!h]
			...
			\caption{\footnotesize Модельные спектры поглощения комплексов с метилтиогруппой, полученные при помощи метода CAM-B3LYP/def2-TZVP в газовой фазе. Лоренцево уширение с полушириной 15\ths нм.}
		\end{figure}
		...
		\begin{figure}[H]
			...
			\caption{\footnotesize Модельные спектры поглощения комплексов с метилтиогруппой, полученные при помощи метода M06-2X/def2-TZVP в газовой фазе. Лоренцево уширение с полушириной 15\ths нм.}
		\end{figure}
		
	\end{columns}
\end{frame}

\begin{frame}{\large Комплексы с метилтиогруппой. Основные электронные переходы \ce{[Cu2[SCH3]2]^{-2}}.}
	\begin{figure}[!htb]
		\centering
		
		\subfloat[Переход 2px$\rarr$2py (396,1\ths нм)]{ \includegraphics[clip,width=0.33\columnwidth]{pictures/orbitals/Cu2L2_1.jpg} }
		\subfloat[Переход 2px$\rarr$3pz (373,4\ths нм)]{ \includegraphics[clip,width=0.33\columnwidth]{pictures/orbitals/Cu2L2_2.jpg} }
		\subfloat[Переход 2px$\rarr$3px (365,3\ths нм)]{ \includegraphics[clip,width=0.33\columnwidth]{pictures/orbitals/Cu2L2_3.jpg} }
		
		\caption{\footnotesize Основные вклады в спектр поглощения комплекса \ce{[Cu2(SCH3)2]^{-2}} в газовой фазе.\\ Проекция изоповерхностей модельной электронной плотности. Метод M06-2X/def2-TZVP.}
	\end{figure}
\end{frame}
...
\begin{frame}{Комплексы с цистеином. Сравнение с экспериментом.}
	\begin{columns}
		...
		\begin{figure}[!h]
			...
			\caption{\footnotesize Модельные спектры поглощения комплексов с цистеином, полученные при помощи метода CAM-B3LYP/def2-TZVP в газовой фазе. Лоренцево уширение с полушириной 15\ths нм.}
		\end{figure}
		...
		\begin{figure}[H]
			...
			\caption{\footnotesize Модельные спектры поглощения комплексов с цистеином, полученные при помощи метода M06-2X/def2-TZVP в газовой фазе. Лоренцево уширение с полушириной 15\ths нм.}
		\end{figure}
...
\begin{frame}{Выводы}
	\begin{enumerate}
		...
		\item Замена метилтиогруппы на цистеин приводит к изменениям геометрии комплексов. Однако степень этих изменений существенно зависит от конкретной структуры: в одних случаях они оказываются минимальными, тогда как в других становятся более выраженными и заметными. При этом спектры поглощения для двух типов структур отличаются значительно.
		\item Спектры поглощения, полученные методом M06-2X/def2-TZVP, подтверждают данные масс-спектрометрии раствора медных НК с цистеином. Наиболее вероятным в растворе являются слабо-поглощающий в области 300–450\ths нм комплекс \ce{[Cu(L)_2]^{-1}} и сильно-поглощающий комплекс \ce{[Cu2(L)_2]^{-2}}.
	\end{enumerate}
\end{frame}
...
\begin{frame}{Практическая значимость работы}
	...
	\begin{enumerate}
		\item Рассмотрение кластеров меди с другими тиолами (глутатион, кофермант А и\ths пр.);
...
\begin{frame}{К ответу на вопрос рецензента}
	\begin{columns}
		...
		\begin{figure}
			\centering
			\includegraphics[width=1\textwidth]{pictures/spectra/exci_wB97X-D3_vacuum.png} 
